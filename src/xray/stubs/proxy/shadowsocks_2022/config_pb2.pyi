...
class MultiUserServerConfig(_message.Message):
    ...
    network: _containers.RepeatedScalarFieldContainer[_network_pb2.Network]
    def __init__(self, method: _Optional[str] = ..., key: _Optional[str] = ..., users: _Optional[_Iterable[_Union[_user_pb2.User, _Mapping]]] = ..., network: _Optional[_Iterable[_Union[_network_pb2.Network, str]]] = ...) -> None: ...
