...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CONFIG']._serialized_end=574
  _globals['_LIMITFALLBACK']._serialized_start=576
  _globals['_LIMITFALLBACK']._serialized_end=664
