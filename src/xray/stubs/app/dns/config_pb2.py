...
from src.xray.stubs.common.net import destination_pb2 as common_dot_net_dot_destination__pb2
from src.xray.stubs.app.router import config_pb2 as app_dot_router_dot_config__pb2
