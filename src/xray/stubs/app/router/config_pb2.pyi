...
class RoutingRule(_message.Message):
    __slots__ = ("tag", "balancing_tag", "rule_tag", "domain", "geoip", "port_list", "networks", "source_geoip", "source_port_list", "user_email", "inbound_tag", "protocol", "attributes", "domain_matcher")
    ...
    domain_matcher: str
    def __init__(self, tag: _Optional[str] = ..., balancing_tag: _Optional[str] = ..., rule_tag: _Optional[str] = ..., domain: _Optional[_Iterable[_Union[Domain, _Mapping]]] = ..., geoip: _Optional[_Iterable[_Union[GeoIP, _Mapping]]] = ..., port_list: _Optional[_Union[_port_pb2.PortList, _Mapping]] = ..., networks: _Optional[_Iterable[_Union[_network_pb2.Network, str]]] = ..., source_geoip: _Optional[_Iterable[_Union[GeoIP, _Mapping]]] = ..., source_port_list: _Optional[_Union[_port_pb2.PortList, _Mapping]] = ..., user_email: _Optional[_Iterable[str]] = ..., inbound_tag: _Optional[_Iterable[str]] = ..., protocol: _Optional[_Iterable[str]] = ..., attributes: _Optional[_Mapping[str, str]] = ..., domain_matcher: _Optional[str] = ...) -> None: ...

class BalancingRule(_message.Message):
    __slots__ = ("tag", "outbound_selector", "strategy", "strategy_settings", "fallback_tag")
    TAG_FIELD_NUMBER: _ClassVar[int]
    ...
    strategy: str
    strategy_settings: _typed_message_pb2.TypedMessage
    fallback_tag: str
    def __init__(self, tag: _Optional[str] = ..., outbound_selector: _Optional[_Iterable[str]] = ..., strategy: _Optional[str] = ..., strategy_settings: _Optional[_Union[_typed_message_pb2.TypedMessage, _Mapping]] = ..., fallback_tag: _Optional[str] = ...) -> None: ...

class StrategyWeight(_message.Message):
    __slots__ = ("regexp", "match", "value")
...
class StrategyLeastLoadConfig(_message.Message):
    __slots__ = ("costs", "baselines", "expected", "maxRTT", "tolerance")
    ...
    maxRTT: int
    tolerance: float
    def __init__(self, costs: _Optional[_Iterable[_Union[StrategyWeight, _Mapping]]] = ..., baselines: _Optional[_Iterable[int]] = ..., expected: _Optional[int] = ..., maxRTT: _Optional[int] = ..., tolerance: _Optional[float] = ...) -> None: ...
