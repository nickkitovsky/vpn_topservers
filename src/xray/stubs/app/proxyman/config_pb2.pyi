...
class ReceiverConfig(_message.Message):
    __slots__ = ("port_list", "listen", "allocation_strategy", "stream_settings", "receive_original_destination", "sniffing_settings")
    ...
    def __init__(self, port_list: _Optional[_Union[_port_pb2.PortList, _Mapping]] = ..., listen: _Optional[_Union[_address_pb2.IPOrDomain, _Mapping]] = ..., allocation_strategy: _Optional[_Union[AllocationStrategy, _Mapping]] = ..., stream_settings: _Optional[_Union[_config_pb2.StreamConfig, _Mapping]] = ..., receive_original_destination: bool = ..., sniffing_settings: _Optional[_Union[SniffingConfig, _Mapping]] = ...) -> None: ...
...
class SenderConfig(_message.Message):
    __slots__ = ("via", "stream_settings", "proxy_settings", "multiplex_settings", "via_cidr")
    ...
    via_cidr: str
    def __init__(self, via: _Optional[_Union[_address_pb2.IPOrDomain, _Mapping]] = ..., stream_settings: _Optional[_Union[_config_pb2.StreamConfig, _Mapping]] = ..., proxy_settings: _Optional[_Union[_config_pb2.ProxyConfig, _Mapping]] = ..., multiplex_settings: _Optional[_Union[MultiplexingConfig, _Mapping]] = ..., via_cidr: _Optional[str] = ...) -> None: ...
