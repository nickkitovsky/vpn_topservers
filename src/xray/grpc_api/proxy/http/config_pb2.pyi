...
class ServerConfig(_message.Message):
    __slots__ = ("accounts", "allow_transparent", "user_level")
    ...
    user_level: int
    def __init__(self, accounts: _Optional[_Mapping[str, str]] = ..., allow_transparent: bool = ..., user_level: _Optional[int] = ...) -> None: ...
