...
class Config(_message.Message):
    ...
    def __init__(self, tag: _Optional[str] = ..., listen: _Optional[str] = ..., service: _Optional[_Iterable[_Union[_typed_message_pb2.TypedMessage, _Mapping]]] = ...) -> None: ...
