...
class Config(_message.Message):
    __slots__ = ("error_log_type", "error_log_level", "error_log_path", "access_log_type", "access_log_path", "enable_dns_log", "mask_address")
    ...
    MASK_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    ...
    enable_dns_log: bool
    mask_address: str
    def __init__(self, error_log_type: _Optional[_Union[LogType, str]] = ..., error_log_level: _Optional[_Union[_log_pb2.Severity, str]] = ..., error_log_path: _Optional[str] = ..., access_log_type: _Optional[_Union[LogType, str]] = ..., access_log_path: _Optional[str] = ..., enable_dns_log: bool = ..., mask_address: _Optional[str] = ...) -> None: ...
